...
struct rtgui_font_engine
{
	...
	void (*font_draw_text)(struct rtgui_font* font, rtgui_dc_t *dc, const char* text, rt_uint32_t len, rtgui_rect_t* rect);
	void (*font_get_metrics)(struct rtgui_font* font, const char* text, rtgui_rect_t* rect);
};
...
/* draw a text */
void rtgui_font_draw(struct rtgui_font* font, rtgui_dc_t *dc, const char* text, rt_uint32_t len, rtgui_rect_t* rect);
