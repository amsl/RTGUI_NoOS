...
int main(int argc, char *argv[])
{
	...
	rt_kprintf("RTGUI NoOS simulator v0.01\n");
			...
			case SDL_MOUSEMOTION:
				{
					...
					rtgui_send(&emouse.parent, sizeof(struct rtgui_event_mouse));
				}
				break;
			...
			case SDL_KEYUP:
				{
					...
					/* send event to server */
					rtgui_send(&ekbd.parent, sizeof(struct rtgui_event_kbd));
				}
				break;
